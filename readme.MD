...
The app is then available at `http://<server-ip>:8080`. Point your reverse proxy to that address and expose it over HTTPS.
...
└── docker-compose.yml   # Compose file (port 8080)
